...
const getAllCategories = async (token) => {
     ...
     // Assuming the API endpoint is '/api/admin/getallcategory'
     // and it returns a list of categories
     // You can adjust the endpoint as per your server configuration
     
     const response = await axios.get('/api/admin/getallcategory');
     return response.data;
}
